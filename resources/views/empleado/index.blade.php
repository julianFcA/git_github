...
<body>
    <main>
        ...
        <br>
        <br>
        <a href= "{{ url ('empleado/create')}}"    class="btn btn-secondary btn-sm"> Registrar empleado </a>
        <br>
        <br>
                        ...
                        <tbody>
                            @foreach ($empleado as $row){
                                <tr>
                                    ...
                                    <td>
                                    <form action="{{url('/empleado/'.$row->id)}}"  method="POST">
                                        @csrf
                                        {{method_field('DELETE')}}
                                    ...
                                    <td>
                                    <a href="{{url('/empleado/'.$row->id.'/edit')}}" class="btn btn-primary btn sm" >Actualizar  </a> 
                                    <!-- <form action="{{url('/empleado/'.$row->id.'/edit')}}"  method="POST">
                                        @csrf
                                        {{ method_field('GET') }}
                                        <input class="btn btn-primary btn sm" type="submit" value='Actualizar' onclick="return confirm('Desea Actualizar los Datos')"> -->
                                        <br>
                                        </br>
                                    </form>
                                    <br>

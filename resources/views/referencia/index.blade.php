...
<body>
    <main>
        ...
        <br>
        <br>
        <a href= "{{ url ('referencia/create')}}"    class="btn btn-secondary btn-sm"> Registrar Referencia </a>
        <br>
        <br>
                        ...
                        <tbody>
                            @foreach ($referencia as $row){
                                <tr>
                                    ...
                                    <td>
                                    <td>
                                    <form action="{{url('/referencia/'.$row->id)}}"  method="POST">
                                        @csrf
                                        {{method_field('DELETE')}}
                                    ...
                                    <td>
                                    <a href="{{url('/referencia/'.$row->id.'/edit')}}" class="btn btn-primary btn sm" >Actualizar  </a> 
                                    </td>    
                                </tr>
